package com.repocleaner.corerequesterapi;
...
public class ApiRequester {
    public static String schedule(UserIO userIO, RequestIO requestIO, String userId, String token, Source source, Sink sink) throws RepoCleanerException {
