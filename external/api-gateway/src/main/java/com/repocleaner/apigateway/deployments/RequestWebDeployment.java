...
public class RequestWebDeployment implements Deployment {
    @Override
    ...
    private List<ParameterModel> createRootPostParameters() {
        ...
        parameters.add(new ParameterModel("RequestWeb", InputLocation.BODY, true, RequestWebSchema.class));
        return parameters;
    }

    private ResponseModel createRootPostRequestResponseResponse() {
        return new ResponseModel("Success", RequestWebResponseSchema.class, ModelCreator.CORS_RESPONSE_HEADERS, null);
    }
    ...
    private List<DefinitionModel> createDefinitions() {
        return ModelCreator.createDefinitions(EmptySchema.class, ErrorSchema.class, RequestWebResponseSchema.class, RequestWebSchema.class);
    }
}
