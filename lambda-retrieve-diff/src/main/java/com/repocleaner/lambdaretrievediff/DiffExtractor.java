...
public class DiffExtractor {
    public Diff extract(String diff) throws RepoCleanerException {
    ...
    private void finishFileDiff(DiffBuilder diffBuilder, FileDiffBuilder fileDiffBuilder) {
    ...
    private void startFileDiff(BufferedReader br, FileDiffBuilder fileDiffBuilder) throws RepoCleanerException {
        try {
    ...
    private void startLineNumbers(String line, FileDiffBuilder fileDiffBuilder) throws RepoCleanerException {
        try {
    ...
    private void finishFilePartDiff(FileDiffBuilder fileDiffBuilder, FilePartDiffBuilder filePartDiffBuilder) throws RepoCleanerException {
    ...
    private void throwError(String error, Exception cause) throws RepoCleanerException {
